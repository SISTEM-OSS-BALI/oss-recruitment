...
import { ScheduleEvaluatorDataModel, ScheduleEvaluatorPayloadCreateModel, ScheduleEvaluatorPayloadUpdateModel } from "@/app/models/schedule-evaluator";

const baseUrl = "/api/admin/dashboard/schedule-evaluator";
const entity = "schedule-evaluator";
const queryKey = "schedule-evaluators";

export const useScheduleEvaluators = ({ queryString }: { queryString?: string }) => {
  ...
  const { mutateAsync: onCreate, isPending: onCreateLoading } = useMutation({
    mutationFn: async (payload: ScheduleEvaluatorPayloadCreateModel) =>
...
export const useScheduleEvaluator = ({ id }: { id: string }) => {
  const queryClient = useQueryClient();
  ...
  const { mutateAsync: onUpdate, isPending: onUpdateLoading } = useMutation({
    mutationFn: async ({
      ...
      id: string;
      payload: ScheduleEvaluatorPayloadUpdateModel;

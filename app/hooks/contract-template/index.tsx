...
import {
  ContractTemplateDataModel,
  ContractTemplatePayloadCreateModel,
  ContractTemplatePayloadUpdateModel,
} from "@/app/models/contract-template";

const baseUrl = "/api/admin/dashboard/contract-template";
const entity = "contract-template";
const queryKey = "contract-templates";
...
export const useContractTemplates = ({
  ...
  const { data, isLoading: fetchLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return result.data.result as ContractTemplateDataModel[];
    },
  });

  const { mutateAsync: onCreate, isPending: onCreateLoading } = useMutation({
    mutationFn: async (payload: ContractTemplatePayloadCreateModel) =>
...
export const useContractTemplate = ({ id }: { id: string }) => {
  const queryClient = useQueryClient();

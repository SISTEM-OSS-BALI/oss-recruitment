...
import {
  ...
  MatriksBaseQuestionPayloadCreateModel,
  MatriksBaseQuestionPayloadUpdateModel,
} from "@/app/models/base-question-matriks";

const baseUrl = "/api/admin/dashboard/base-question-matriks";
const entity = "base-question-matriks";
const queryKey = "base-question-matriks";

export const useQuestionBaseMatriks = ({
  queryString,
}: {
  queryString?: string;
}) => {
  ...
  const { data, isLoading: fetchLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return result.data.result as MatriksBaseQuestionDataModel[];
    },
  });

  const { mutateAsync: onCreate, isPending: onCreateLoading } = useMutation({
    mutationFn: async (payload: MatriksBaseQuestionPayloadCreateModel) =>
...
export const useQuestionBaseMatrik = ({ id }: { id: string }) => {
  const queryClient = useQueryClient();

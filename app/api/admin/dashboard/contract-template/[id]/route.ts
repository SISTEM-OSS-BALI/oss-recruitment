...
} from "@/app/providers/contract-template";
...
export const GET = async (
  ...
  try {
    ...
    const data = await GET_CONTRACT_TEMPLATE(id);
...
export const PUT = async (
  ...
  try {
    ...
    const data = await UPDATE_CONTRACT_TEMPLATE(id, payload);
...
export const DELETE = async (
  ...
  try {
    ...
    const data = await DELETE_CONTRACT_TEMPLATE(id);

...
import { useLocationByUserId } from "@/app/hooks/location";
...
export default function CreateJobUI({ jobId }: { jobId?: string }) {
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      ...
      location_id: draftJob.location_id ?? undefined,
  ...
  const handleGenerateJobDescription = useCallback(async () => {
    ...
    const locationId = form.getFieldValue("location_id");

    if (!jobTitle || !jobRole || !locationId) {
      message.warning(
        "Lengkapi Job Title, Job Role, dan Location sebelum generate deskripsi."
      );
      return;
    }
        ...
        {currentStep === 0 && (
          <>
            ...
            <Card style={{ padding: 24, marginBottom: 24 }}>
              ...
              <Form.Item
                name="type_job"
                label={<Typography.Text strong>Job Type</Typography.Text>}
              >
                <Select size="large">
                  <Select.Option value="TEAM_MEMBER">Team Member</Select.Option>
                  <Select.Option value="REFFERAL">Referral</Select.Option>
                </Select>
              </Form.Item>
            ...
            <Card style={{ padding: 24, marginBottom: 24 }}>
              ...
              <Paragraph type="secondary" style={{ marginBottom: 24 }}>
                Fill in the job location details below.
              </Paragraph>
              ...
              <Form.Item
                label={<Typography.Text strong>Location</Typography.Text>}
                required
              >
                <Row gutter={16}>
                  <Col xs={24} md={24}>
                  ...
                  <Col xs={24} md={24} style={{ marginTop: 12 }}>
                    <Form.Item
                ...
                <Col span={24} md={24}>
                  <div style={{ marginTop: 8 }}>
                    <RequirementCard
                      ...
                      descriptions="Become a VIP member to use this benefit. Upgrade to VIP."
                    />
                  </div>
                </Col>
                <Col span={24} md={24}>
            ...
            {/* Card #5 - Additional mandatory requirements */}
            <Card style={{ padding: 24, marginBottom: 24, marginTop: 24 }}>
              <div
                style={{
                  borderBottom: "1px solid #f3f4f6",
                  paddingBottom: 12,
              ...
              >
                ...
                <Paragraph type="secondary" style={{ marginBottom: 0 }}>
                  Candidates will be required to have these details when
                  applying for this job.
                </Paragraph>
              </div>
              <div style={{ marginTop: 16, display: "grid", gap: 12 }}>
                <RequirementCard
                  title="Make profile photo required"
                  descriptions="Become a VIP member to use this benefit. Upgrade to VIP."
                />
                <RequirementCard
                  title="Make resume required"
                  descriptions="Become a VIP member to use this benefit. Upgrade to VIP."
                />
              </div>
            </Card>
